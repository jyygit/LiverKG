...
path = '../../data/all'
train = pd.read_csv(f'{path}/train.tsv', header=None, sep='\t', names=['h', 'r', 't'],dtype='str')
valid = pd.read_csv(f'{path}/valid.tsv', header=None, sep='\t', names=['h', 'r', 't'],dtype='str')
test = pd.read_csv(f'{path}/test.tsv', header=None, sep='\t', names=['h', 'r', 't'],dtype='str')
