...
def parse_args():
	...
	# network arguments
	args.add_argument("-data", "--data", default="./data/KG1234/", help="data directory")
	args.add_argument("-e_g", "--epochs_gat", type=int, default=200, help="Number of epochs")
	args.add_argument("-e_c", "--epochs_conv", type=int, default=150, help="Number of epochs")
	args.add_argument("-w_gat", "--weight_decay_gat", type=float, default=0, help="L2 reglarization for gat")
	args.add_argument("-w_conv", "--weight_decay_conv", type=float, default=0, help="L2 reglarization for conv")
	...
	args.add_argument("-outfolder", "--output_folder", 
                   default="./checkpoints/KG5/out/", help="Folder name to save the models.")

	args.add_argument("-eval_type", "--eval_type", default='last')
	# arguments for GAT
	args.add_argument("-b_gat", "--batch_size_gat", type=int, default=128, help="Batch size for GAT")
	...
	args.add_argument("-drop_GAT", "--drop_GAT", type=float, default=0.1, help="Dropout probability for SpGAT layer")
	...
	args.add_argument("-margin", "--margin", type=float, default=0, help="Margin used in hinge loss")
	...
	args.add_argument("-drop_conv", "--drop_conv", type=float, default=0.1, help="Dropout probability for convolution layer")
